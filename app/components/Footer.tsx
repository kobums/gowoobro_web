...
// --- Styled Components for Language Menu ---
...
const LanguageMenuItem = styled.button<{ isActive: boolean }>`
  background-color: ${p => p.isActive ? '#f3f4f6' : 'transparent'};
  color: ${p => p.isActive ? '#000' : '#4b5563'};
...
export default function Footer({ dict, lang }: { dict?: any, lang?: string }) {
  ...
  const t = dict || {
    ...
    flutter_apps: "Flutter Apps",
    app_store: "App Store",
    play_store: "Play Store",
    nextjs_projects: "Next.js Projects",
    ...
    language: "English",
    copyright: "© {year} Gowoobro. All rights reserved."
  };
  ...
  return (
    <FooterWrapper aria-labelledby="footer-heading">
      ...
      <ContentWrapper>
        <LinksGrid>
          <LinkColumn>
            <ColumnTitle>{t.projects}</ColumnTitle>
            <Divider />
            <LinkList>
              <LinkItem><div style={{cursor: 'default', opacity: 0.5, marginBottom: '4px'}}>{t.mobile_apps}</div></LinkItem>
              <SubList>
                <LinkItem><a href="/apps">{t.flutter_apps}</a></LinkItem>
                <LinkItem><a href="https://apps.apple.com/us/app/gowoobro-docs/id1487937127">{t.app_store}</a></LinkItem>
                <LinkItem><a href="https://apps.apple.com/us/app/gowoobro-docs/id1487937127">{t.play_store}</a></LinkItem>
              </SubList>
              <Divider />
              <LinkItem><div style={{cursor: 'default', opacity: 0.5, marginBottom: '4px'}}>{t.web_platforms}</div></LinkItem>
              <SubList>
                <LinkItem><a href="/web">{t.nextjs_projects}</a></LinkItem>
                <LinkItem><a href="/web">{t.react_apps}</a></LinkItem>
              </SubList>
            </LinkList>
          </LinkColumn>
          ...
          <LinkColumn>
            ...
            <Divider />
            <LinkList>
              <LinkItem><a href="mailto:kobums@naver.com">{t.email}</a></LinkItem>
              <LinkItem><a href="https://open.kakao.com/o/sdtS7Hlh" target="_blank" rel="noreferrer">{t.kakao}</a></LinkItem>
            </LinkList>
          </LinkColumn>
          ...
          <DownloadColumn>
            ...
            <Divider />
            <LinkList>
              <LinkItem><a href="/resume.pdf" target="_blank">{t.resume}</a></LinkItem>
              <LinkItem><a href="/portfolio.pdf" target="_blank">{t.portfolio}</a></LinkItem>
            </LinkList>
          </DownloadColumn>
        </LinksGrid>
        ...
        <BottomSection>
          ...
          <BottomContent>
            <SocialSection>
              <LanguageContainer ref={menuRef}>
                <LanguageButton 
                  type="button" 
                  onClick={() => setIsLanguageMenuOpen(!isLanguageMenuOpen)}
                >
                  <span>{currentLang === 'en' ? 'English' : '한국어'}</span>
                  <svg 
                    width="16" 
                    height="16" 
                    viewBox="0 0 24 24" 
                    ...
                    stroke="currentColor" 
                    strokeWidth="2"
                    style={{ marginLeft: '0.5rem', transform: isLanguageMenuOpen ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.2s' }}
                  >
              ...
              <Copyright>{t.copyright.replace('{year}', new Date().getFullYear().toString())}</Copyright>
            </BottomContent>
          </BottomSection>
        </ContentWrapper>
      </FooterWrapper>
